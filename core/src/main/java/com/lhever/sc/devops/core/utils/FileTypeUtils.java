...
public class FileTypeUtils {
    ...
    public static String mediaTypeString(MediaType mediaType) {
        String result = (mediaType == null ? CommonConstants.EMPTY : mediaType.toString());
        return result;
    }

    public static String type(MediaType mediaType) {
        String result = (mediaType == null ? CommonConstants.EMPTY : mediaType.getType());
        return result;
    }

    public static String subType(MediaType mediaType) {
        String result = (mediaType == null ? CommonConstants.EMPTY : mediaType.getSubtype());
        return result;
    }
