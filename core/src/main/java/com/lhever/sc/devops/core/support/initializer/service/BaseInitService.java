...
import com.lhever.sc.devops.core.support.initializer.ctx.InitContext;
...
public abstract class BaseInitService {
    ...
    protected static String trimFileName(String fileName) {
        ...
        fileName = (fileName.startsWith(CommonConstants.SLASH) || fileName.startsWith(CommonConstants.BACK_SLASH))
