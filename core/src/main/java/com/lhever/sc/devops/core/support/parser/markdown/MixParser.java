package com.lhever.sc.devops.core.support.parser.markdown;
 ...
 * </p>
 *
 * @author lihong10 2019/4/9 13:32
 * @version v1.0
 * @modificationHistory=========================逻辑或功能性重大变更记录
 * @modify by user: {修改人} 2019/4/9 13:32
 * @modify by reason:{方法名}:{原因}
 */
public class MixParser extends MDURLParser {
    ...
    public String handle(String text, int offset, int startIndex, int middleIndex, int endIndex, String title, String url) {
        ...
        if (startIndex > 0 && (startIndex - 1) >= offset && text.charAt(startIndex - 1) == '!') {
            System.out.println("url 代表图片");

        } else {

            System.out.println("url代表超链接");
        }
