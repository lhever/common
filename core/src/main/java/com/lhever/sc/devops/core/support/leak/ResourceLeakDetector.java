package com.lhever.sc.devops.core.support.leak;
 ...
 * </p>
 *
 * @author lihong10 2019/7/31 9:18
 * @version v1.0
 * @modificationHistory=========================逻辑或功能性重大变更记录
 * @modify by user: {修改人} 2019/7/31 9:18
...
public class ResourceLeakDetector<T> {
    ...
    private static final String PROP_LEVEL = "open.leakDetection.level";
    private static final Level DEFAULT_LEVEL = Level.SIMPLE;

    private static final String PROP_TARGET_RECORDS = "open.leakDetection.targetRecords";
    private static final int DEFAULT_TARGET_RECORDS = 4;

    private static final String PROP_SAMPLING_INTERVAL = "open.leakDetection.samplingInterval";
    ...
    static {
        ...
        if (SystemPropertyUtils.get("open.noResourceLeakDetection") != null) {
            disabled = SystemPropertyUtils.getBoolean("open.noResourceLeakDetection", false);
            logger.debug("-Dopen.noResourceLeakDetection: {}", disabled);
            logger.warn(
                    "-Dopen.noResourceLeakDetection is deprecated. Use '-D{}={}' instead.",
        ...
        String levelStr = defaultLevel.name();

        // If new property name is present, use it
        levelStr = SystemPropertyUtils.get(PROP_LEVEL, levelStr);
        Level level = Level.parseLevel(levelStr);

        TARGET_RECORDS = SystemPropertyUtils.getInt(PROP_TARGET_RECORDS, DEFAULT_TARGET_RECORDS);
        SAMPLING_INTERVAL = SystemPropertyUtils.getInt(PROP_SAMPLING_INTERVAL, DEFAULT_SAMPLING_INTERVAL);
    ...
    public ResourceLeakDetector(Class<?> resourceType) {
        this(ObjectUtils.simpleClassName(resourceType));
    }
    ...
    public ResourceLeakDetector(Class<?> resourceType, int samplingInterval) {
        this(ObjectUtils.simpleClassName(resourceType), samplingInterval, Long.MAX_VALUE);
    }
    ...
    /**
     * Creates a new {@link ResourceLeakTracker} which is expected to be closed via {@link ResourceLeakTracker#close(T trackedObject)} when the
     ...
     */
    @Deprecated
    public final ResourceLeakTracker open(T obj) {
        return track0(obj);
    }
    ...
    protected void reportUntracedLeak(String resourceType) {
        logger.error("LEAK: {}.release() was not called before it's garbage-collected. " +
                        ...
                        "See http://netty.io/wiki/reference-counted-objects.html for more information.",
                resourceType, PROP_LEVEL, Level.ADVANCED.name().toLowerCase(), ObjectUtils.simpleClassName(this));
    }
    ...
    private static final class DefaultResourceLeak<T>
         ...
         * <li>  The very last com.hikvision.community.health.chep.modules.access will always be recorded. This comes as a property of 1.
         ...
         * if something should be recorded. This means that if there is a deterministic com.hikvision.community.health.chep.modules.access pattern, it is now
         * possible to see what other accesses occur, rather than always dropping them. Second, after
         * {@link #TARGET_RECORDS} accesses, backoff occurs. This matches typical com.hikvision.community.health.chep.modules.access patterns,
        ...
        public String toString() {
            ...
            buf.append("Recent com.hikvision.community.health.chep.modules.access records: ").append(NEWLINE);
