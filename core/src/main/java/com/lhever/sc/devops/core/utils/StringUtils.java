...
import com.lhever.sc.devops.core.constant.RegExp;
...
public class StringUtils {
    ...
    public static byte[] getBytes(String src) {
        try {
            return src.getBytes(CommonConstants.CHARSET_UTF8);
        } catch (UnsupportedEncodingException e) {
            logger.error("encoding error", e);
        }
        return null;
    ...
    public static String checkNull(String data, String msg) {
        if (data == null) {
    ...
    public static String checkBlank(String data, String msg) {
