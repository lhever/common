...
public class MdcUtils {
    ...
    public static String generateRequestId() {
        return StringUtils.getUuid() + CommonConstants.UNDER_SCORE + System.currentTimeMillis();
    }
    ...
    public static void setRequestIdIfAbsent() {
        if (get(CommonConstants.REQUEST_ID) == null) {
            put(CommonConstants.REQUEST_ID, generateRequestId());
        }
    }
    ...
    public static void setRequestIdIfAbsent(String requestId) {
        if (get(CommonConstants.REQUEST_ID) == null) {
            put(CommonConstants.REQUEST_ID, requestId);
        }
    }
    ...
    public static String getRequestId() {
        return get(CommonConstants.REQUEST_ID);
    }
    ...
    /**
     * 方法的功能说明: 从HttpServletRequest对象中获取名为requestId的请求头
     *
     * @param
     * @return
     * @author lihong10 2018/12/17 12:07
    ...
    public static String getRequestId(HttpServletRequest request) {
        ...
        return request.getHeader(CommonConstants.REQUEST_ID);
    }
    ...
    public static void setRequestId(String traceId) {
        put(CommonConstants.REQUEST_ID, traceId);
    }
    ...
    public static void removeRequestId() {
        remove(CommonConstants.REQUEST_ID);
    }
