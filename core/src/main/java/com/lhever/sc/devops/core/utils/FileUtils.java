...
public class FileUtils {
    ...
    public static void writeToFileByNio(String fullFileName, String content) {
        writeToFileByNio(fullFileName, content, CommonConstants.CHARSET_UTF8);
    ...
    public static String trimTail(String fileName) {
        ...
        while (fileName.endsWith(CommonConstants.SLASH) || fileName.endsWith(CommonConstants.BACK_SLASH)) {
    ...
    public static String trimHead(String fileName) {
        ...
        fileName = fileName.trim();
        while (fileName.startsWith(CommonConstants.SLASH) || fileName.startsWith(CommonConstants.BACK_SLASH)) {
